...
export function getLocalisedCharacterClass(characterClass: CharacterClass, server: MapleServer) {
...
export function getLocalisedItemEquipOptions(itemEquipOption: ItemEquipOption, server: MapleServer) {
    if (server === MapleServer.KMS) {
...
export function getLocalisedSymbolEquipOptions(symbolEquipOption: SymbolEquipOption, server: MapleServer) {
    if (server === MapleServer.KMS) {
...
export function getLocalisedStatName(statName: StatName, server: MapleServer) {
    if (server === MapleServer.KMS) {
